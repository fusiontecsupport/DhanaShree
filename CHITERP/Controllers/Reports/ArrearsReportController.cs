...
{
    public class ArrearsReportController : Controller
    {
        // GET: ArrearsReport
        #region context 
        ...
        public void ArrearsXLRpt()
        {
            ...
            string filename = "ArrearRpt_"+DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
            filename = filename + ".xlsx";
            string query = "";


            query = "exec [Arrears_Clients_Summary] @product=" + prdtid + "";
            ...
            da.Fill(ds, "ArrearsClientsAcSummary");
            //da.Fill(dt);
            con.Close();
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                dt1 = ds.Tables[1];
                dt1.TableName = "ArrearsClientsAcSummary";
