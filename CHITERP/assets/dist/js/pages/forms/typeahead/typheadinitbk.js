$('#CATENAME').typeahead({
...
},
    {
        ...
        source: function (query, processSync, processAsync) {
            ...
            //var oldFn = $.ui.typeahead.prototype._renderItem;
            ...
            var term = $('#CATENAME').val();
            var burl = window.location.origin;
            var url = burl + '/EmployeeTerritoryMapping/GetEmployeeList/?term=' + term;
            ...
            return $.ajax({
                ...
                success: function (jsondata) {
                    ...
                    //    $.each(item, function (i, jsondata) {
                    //        jsonArg.label = jsondata;
                    //        jsonArg.value = jsondata;
                    //    });
                    //}));
                    //return processAsync(jsonArg);
                    return processAsync(jsondata);
                }

            });
        },
        select: function (selection) {
            $("#CATENAME").val(selection.term);
            $("#CATEID").val(selection.value);
        }
    }
);
