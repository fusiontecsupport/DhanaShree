function GetDetail() {
    var db = "";
    var strim = $(".ASTMRID").val();
    var url = "";
    if (strim == 0) {
        url = '@Url.Action("GetDetails", "RepairSlabMaster")/?id=' + $(".ATARIFFMID option:selected").val() + "~" + 0;
    }
    else {
        url = '@Url.Action("GetDetails", "RepairSlabMaster")/?id=' + $(".ATARIFFMID option:selected").val() + "~" + strim;
    }
