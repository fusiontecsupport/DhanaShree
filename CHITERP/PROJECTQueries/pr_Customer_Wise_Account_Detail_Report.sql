...
-- exec [dbo].[pr_Customer_Wise_Account_Detail_Report] 111
	...
	set ticketnumber = 1 where isnull(ticketnumber,0) = 0 
      ...
      SELECT tmp01.Product, tmp01.SubscriptionCode, 
			tmp01.PersonID,
			 ...
			 Tmp_Ledger_Balance_Detail.ChitAsonPaidDueAmt
			 as CollectedAmount, 
			 ...
			 'ActualOutstanding'= case when tmp01.product = 'Chit' then ((b.dueamt-b.divamt)*ticketnumber)-CollectedAmount  else Tmp_Ledger_Balance_Detail.BalAmt end,
