use DSFinFusion
go
-- exec [dbo].[Active_Clients_Summary]   29
-- exec [Active_Clients_Summary] 30
-- exec [Active_Clients_Summary] 0

alter PROCEDURE [dbo].[Active_Clients_Summary] 
@product int=0,
@usrid varchar(50)='',
@empid int =0,
@routeid int =0,
...
BEGIN 
	...
	ColAgt1,CmsnAgt1
	from VW_Active_Subscription_Details a(nolock)
