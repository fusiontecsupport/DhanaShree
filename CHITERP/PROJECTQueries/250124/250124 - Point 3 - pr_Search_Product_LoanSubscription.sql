...
BEGIN
	...
	SubsDate varchar(12),
	LoanSubscriptionCode varchar(150),
	  --, DISPSTATUS smallint
	...
	StatusTypeID , LoanSchemeCode ,	RepaymentIntervalTypeDesc ,  InterestDeductionTypeDesc, StatusTypeDesc, SubsDate,LoanSubscriptionCode,
