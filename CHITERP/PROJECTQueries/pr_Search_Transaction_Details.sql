...
-- Description: <Transaction Entrydetails>  
-- Exec [dbo].[pr_Search_Transaction_Details] @FilterTerm='',@SortIndex=1,@SortDirection='asc',@StartRowNum=1,@EndRowNum=10,@TotalRowsCount=100,@FilteredRowsCount=100,@CUSRID='admin'  
-- =============================================  
alter PROCEDURE [dbo].[pr_Search_Transaction_Details]  
